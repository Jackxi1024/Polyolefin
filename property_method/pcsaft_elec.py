...
def pcsaft_vaporP(p_guess, x, m, s, e, t, **kwargs):
    ...
    result = minimize(vaporPfit, p_guess, args=(x, m, s, e, t, kwargs), tol=1e-10, method='Nelder-Mead', options={'maxiter': 100})
...
def pcsaft_ares(t, rho, x, m, s, e, k_ij=None, e_assoc=None, vol_a=None, dipm=None, \
            dip_num=None, z=None, dielc=None):
    """
