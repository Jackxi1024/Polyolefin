...
# 断开，输入
# Aspen的撕裂物流
# z6 = np.array([3724.461, 679.8047, 539.4908, 48.19503, 0, 0, 0, 0])
# cycle_gas.input(334.8567, 3200000, None, None, z6, "Mole & Mole Flow")

z6 = np.array([3452.6416421453987, 630.1811508507599, 500.0683019448442 , 44.72755957156416, 0, 0, 0, 0])
cycle_gas.input(334.737516630587, 3200000, None, None, z6, "Mole & Mole Flow")
...
# 设置多流股换热器的操作参数
specs = {
    vap_b:{"Outlet": cycle_gas2, "Valid phases":"vapor-liquid", "spec":None, 
