...
from polymer_model.thermodynamics.args import args as pure_args
...
if __name__ == "__main__":
    ...
    feed = {
        "Component Mole Flow": np.array([5396.361, 1014.193, 551.1792, 50.57089, 0, 0.00439311, 0.0243309, 0]),
        "CPSFLOW": 0.000375,
        "CDSFLOW": 0,
        "CVSFLOW": np.zeros(4),
        "CISFLOW": np.zeros(4), 
